...
{
    #[Route('/{team}', name: 'wheel', requirements: ['team' => 'sith|trooper|jedi|copilop|valSE'])]
    ...
    #[Route('/{team}/spin', name: 'spin_wheel', requirements: ['team' => 'sith|trooper|jedi|copilop|valSE'])]
    ...
    #[Route('/{team}/add-name', name: 'add_name', methods: ['POST'], requirements: ['team' => 'sith|trooper|jedi|copilop|valSE'])]
    ...
    #[Route('/{team}/reAddName/{id}', name: 're_add_name', methods: ['POST'], requirements: ['team' => 'sith|trooper|jedi|copilop|valSE'])]
    ...
    #[Route('/{team}/reAddNameAll', name: 're_add_name_all', methods: ['POST'], requirements: ['team' => 'sith|trooper|jedi|copilop|valSE'])]
